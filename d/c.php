    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 form-container">
            ...
            if (isset($_POST['Submit'])){
                ...
                echo '<h4 class="alert-heading">✅ ข้อมูลการสมัครสำเร็จ!</h4>';
                echo '<p>คุณได้สมัครสมาชิกเรียบร้อยแล้ว รายละเอียดดังนี้:</p>';
                echo '<ul class="list-unstyled">';
                echo '<li><strong>ชื่อ-สกุล:</strong> '.$fullname.'</li>';
                echo '<li><strong>เบอร์โทร:</strong> '.$phone.'</li>';
                echo '<li><strong>ความสูง:</strong> '.$height.' ซม.</li>';
                echo '<li><strong>สาขาวิชา:</strong> '.$major.'</li>';
                echo '<li><strong>สีที่ชอบ:</strong> '.$color.' <span class="d-inline-block border border-dark rounded-circle" style="width: 20px; height: 20px; background-color: '.$color.';"></span></li>';
                echo '</ul>';
                echo '</div>';
            }
            ?>
